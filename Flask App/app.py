...
def preprocess_data(data):
    ...
    df.drop(
        ['MODEL YEAR', 'FUEL CONSUMPTION CITY (L/100)', 'FUEL CONSUMPTION HWY (L/100)', 'COMB (mpg)', 'Smog Rating'],
        axis=1, inplace=True)

    enc_make = {'Audi': 0.1, 'BMW': 0.2, 'Ford': 0.3, 'Honda': 0.4, 'Mercedes-Benz': 0.5, 'Toyota': 0.6,
                'Volkswagen': 0.7}
